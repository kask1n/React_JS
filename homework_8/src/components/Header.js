  ...
  return (
    <header className="header center">
      <div className="header__left">
        ...
        <Link to="#">
          <svg className="header_icon_search" width="27" height="28" viewBox="0 0 27 28" fill="none"
      ...
      <nav className="header__right">
        <label for="header__check">
          <svg className="header_icon_menu" width="32" height="23" viewBox="0 0 32 23" fill="none"
            xmlns="http://www.w3.org/2000/svg">
            <path d="M0 23V20.31H32V23H0ZM0 12.76V10.07H32V12.76H0ZM0 2.69V0H32V2.69H0Z" fill="#E8E8E8" />
          </svg>
        </label>
        <Link className="header__link-site" to="/registration">
          <svg className="header_icon_reg" width="29" height="29" viewBox="0 0 29 29" fill="none"
            xmlns="http://www.w3.org/2000/svg">
            <path
        ...
        <Link className="header__link-site" to="/cart">
          <svg className="header_icon_cart" width="32" height="29" viewBox="0 0 32 29" fill="none"
            xmlns="http://www.w3.org/2000/svg">
            <path
      ...
      <input className="header__checkbox" id="header__check" type="checkbox"></input>
      <div className="mobile-menu">
        <div className="mobile-menu__link-site">
          <Link to="/registration">
            <img src="img/reg.svg" alt="reg.svg"></img>
          </Link>
          <Link to="/cart">
            <img src="img/cart.svg" alt="cart.svg"></img>
          </Link>
        </div>
        <h3 className="mobile-menu__heading">MENU</h3>
        <div className="mobile-menu__box">
          <div className="mobile-menu__item">
            <Link to="/catalog" className="mobile-menu__title">MEN</Link>
          ...
          <div className="mobile-menu__item">
            <Link to="/catalog" className="mobile-menu__title">WOMEN</Link>
            <ul className="mobile-menu__list">
              <li><Link className="mobile-menu__link" to="/catalog">Accessories</Link></li>
              <li><Link className="mobile-menu__link" to="/catalog">Bags</Link></li>
              <li><Link className="mobile-menu__link" to="/catalog">Denim</Link></li>
