    ...
    <>
      <section className="head center">
        ...
        <ul className="breadcrumb">
          ...
          <li className="breadcrumb__box-link"><Link to="#" className="breadcrumb__link">NEW ARRIVALS</Link></li>
        </ul>
      </section>
      <div className="slider">
        <Link to="/product" className="slider__arrow slider__arrow_left">
        ...
        <img src="img/slider.png" alt="slider"></img>
        <Link to="/product" className="slider__arrow slider__arrow_right">
          <svg width="13" height="23" viewBox="0 0 13 23" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
      ...
      <section className="content">
        ...
        <div className="sort">
          ...
          <details className="sort__details">
            ...
            <div className="sort__content">
              <label className="sort__label">
                <input type="checkbox" name="" id=""></input> <span>1</span>
              </label>
              <label className="sort__label">
                <input type="checkbox" name="" id=""></input> <span>2</span>
              </label>
              <label className="sort__label">
                <input type="checkbox" name="" id=""></input> <span>3</span>
              </label>
              <label className="sort__label">
                <input type="checkbox" name="" id=""></input> <span>4</span>
              </label>
            </div>
          </details>
        </div>
        <div className="button product_button">
